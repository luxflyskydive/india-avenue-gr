(function () {
  ...
  const KB = {
    ...
    dietary: {
      keywords: [
        'allergy', 'allergies', 'allergen', 'allergens', 'gluten', 'gluten free',
        'gluten-free', 'celiac', 'coeliac', 'nut allergy', 'peanut allergy',
        'dairy allergy', 'lactose', 'lactose intolerant', 'dairy free',
        'dietary restriction', 'dietary restrictions', 'dietary needs',
        'special diet', 'food intolerance', 'intolerance', 'wheat free',
        'wheat allergy', 'soy allergy', 'egg allergy', 'shellfish allergy',
        'fish allergy', 'tree nut', 'sesame', 'halal', 'kosher',
        'accommodate', 'can you accommodate', 'is the food halal',
        'do you cater for allergies', 'cater for allergies',
        'can you cater for allergies', 'do you have gluten free',
        'is anything gluten free', 'what is gluten free on the menu',
        'i have an allergy', 'i am allergic', 'safe for allergies',
        'accommodation', 'dietary accommodation', 'nutritional information'
      ],
      response: () => `**Dietary Needs at India Avenue** 🌱\n\n✅ **Gluten-sensitive:** Many dishes are marked **GF** on our menu. Tell your server so the kitchen takes extra care.\n\n✅ **Vegetarian & Vegan:** Extensive selection — we're proud of our veg menu!\n\n✅ **Allergies:** Please inform your server when you arrive, or mention it when reserving. We take allergies seriously.\n\n⚠️ *Our kitchen handles nuts, dairy, gluten and shellfish, so cross-contamination cannot be fully guaranteed for severe allergies.*\n\nCall ahead if you have concerns: **+1 (203) 717-1567** — we'll walk through the menu with you.`
    },
